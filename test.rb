...
request = Evrblk::Moab::V0::CreateQueueRequest.new(
  ...
  retry_strategy: Evrblk::Moab::V0::RetryStrategy.new(
    retry_intervals_in_seconds: [1, 2, 3, 4, 5],
  ),
  dequeuing_settings: Evrblk::Moab::V0::DequeuingSettings.new(
    max_in_progress_tasks: 100,
    rate_limiting: Evrblk::Moab::V0::TokenBucketRateLimiting.new(
      max_tokens: 1000,
      interval: 5,
  ...
  dead_letter_queue_config: Evrblk::Moab::V0::DeadLetterQueueConfig.new(
    enable: true,
    max_size: 1000000,
...
signature = alfa.sign(request, timestamp, "Moab", "CreateQueue")
puts(signature)
